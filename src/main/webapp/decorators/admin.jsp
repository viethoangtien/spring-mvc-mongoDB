...
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/html5shiv.min.js' />"></script>--%>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/respond.min.js' />"></script>--%>
<script type="text/javascript" src="<c:url value='/template/admin/js/jquery-2.1.4.min.js' />"></script>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/jquery-1.11.3.min.js' />"></script>--%>
<script type="text/javascript" src="<c:url value='/template/admin/js/bootstrap.min.js' />"></script>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/excanvas.min.js' />"></script>--%>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/jquery-ui.custom.min.js' />"></script>--%>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/jquery.ui.touch-punch.min.js' />"></script>--%>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/jquery.easypiechart.min.js' />"></script>--%>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/jquery.sparkline.index.min.js' />"></script>--%>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/jquery.flot.min.js' />"></script>--%>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/jquery.flot.pie.min.js' />"></script>--%>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/jquery.flot.resize.min.js' />"></script>--%>
<%--<script type="text/javascript" src="<c:url value='/template/admin/js/admin-home.js' />"></script>--%>
