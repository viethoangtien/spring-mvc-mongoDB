    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">Process List</h3>
...
<%--                                    <th class="hidden-480">recordType</th>--%>
                                    ...
                                    <th class="hidden-480">CPU time</th>
<%--                                    <th class="hidden-480">section</th>--%>
                                    <th class="hidden-480">Elapsed time</th>
...
<%--                                        <td class="hidden-480">${item.section}</td>--%>
                                        <td class="hidden-480">${item.cpuTime}</td>
                                        <td class="hidden-480">${item.elapsedTime}</td>
