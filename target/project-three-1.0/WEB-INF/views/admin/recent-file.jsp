    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">Recent file</h3>
                        ...
                        <div>
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="hidden-480">File extension</th>
                                    <th class="hidden-480">File owner</th>
                                    <th class="hidden-480">Open time</th>
...
<%--                                    </th>--%>
                                ...
                                <c:forEach var="item" items="${model}">
                                    <tr>
                                        ...
                                        <td class="hidden-480">${item.extension}</td>
                                        <td class="hidden-480">${item.fileOwner}</td>
                                        <td class="hidden-480">${item.openTime}</td>
                                        <td class="hidden-480">${item.fileSize}</td>
