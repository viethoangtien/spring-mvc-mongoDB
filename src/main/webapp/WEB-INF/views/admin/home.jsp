        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="alert alert-block alert-success">
                    ...
                    Загрузить исходники с <a href="https://github.com/bopoda/ace">github</a> (with minified ace js/css
                    files).
                </div>
                                        ...
                                        <div class="itemdiv dialogdiv">
                                            <div class="user">
                                                <img alt="Alexa's Avatar"
                                                     src="<c:url value="/template/admin/images/avatars/avatar1.png" />"/>
                                            </div>
                                        ...
                                        <div class="itemdiv dialogdiv">
                                            <div class="user">
                                                <img alt="John's Avatar"
                                                     src="<c:url value="/template/admin/images/avatars/avatar.png" />"/>
                                            </div>
                                        ...
                                        <div class="itemdiv dialogdiv">
                                            <div class="user">
                                                <img alt="Bob's Avatar"
                                                     src="<c:url value="/template/admin/images/avatars/user.jpg" />"/>
                                            </div>
                                        ...
                                        <div class="itemdiv dialogdiv">
                                            <div class="user">
                                                <img alt="Jim's Avatar"
                                                     src="<c:url value="/template/admin/images/avatars/avatar4.png" />"/>
                                            </div>
