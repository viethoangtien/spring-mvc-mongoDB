    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">Routing Table</h3>
...
<%--                                    <th class="hidden-480">recordType</th>--%>
                                    ...
                                    <th class="hidden-480">Gateway</th>
<%--                                    <th class="hidden-480">section</th>--%>
                                    <th class="hidden-480">Interface</th>
                                    <th class="hidden-480">Metric</th>
                                ...
                                <c:forEach var="item" items="${model}">
                                    <tr>
                                        ...
                                        <td>${item.networkDestination}</td>
<%--                                        <td width="50px">${item.recordType}</td>--%>
                                        <td class="hidden-480">${item.netmask}</td>

<%--                                        <td class="hidden-480">--%>
<%--                                            <span class="label label-sm label-warning">${item.dataLength}</span>--%>
<%--                                        </td>--%>
<%--                                        <td class="hidden-480">${item.section}</td>--%>
                                        <td class="hidden-480">${item.gateway}</td>
                                        <td class="hidden-480">${item.interfacee}</td>
                                        <td class="hidden-480">${item.metric}</td>
